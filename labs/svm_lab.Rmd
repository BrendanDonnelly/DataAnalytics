---
title: 'Data Analytics: Support Vector Machine In- Class, Lab '
...
#using the svm() function to fit the support vector classifier for a given value of the cost parameter.

# demonstrating the use of this function on a two-dimensional example to plot the resulting decision boundary.
...
# They are not. Next, fit the support vector classifier. 

# In order for the svm() function to perform classification, must encode the response as a factor variable.

# Create new data frame with the response coded as a factor.
